...
public class GuiOcr {
    ...
    public static void gui(String fileNameResult, List<String> strings, JTextField error, List<String> compare) throws IOException {
        GuiOcr gui = new GuiOcr();
        gui.go(fileNameResult, strings, error, compare);
    }

    public void go(String fileNameResult, List<String> strings, JTextField error, List<String> compare) throws IOException {
