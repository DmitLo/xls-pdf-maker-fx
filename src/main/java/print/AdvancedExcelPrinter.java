...
//                columnPrint = new ArrayList<>();
                ...
                if (lengthType >= cut) {
                    ...
                    for (int i = 0; i < a; i++) {
                        ...
                        //print.Print printListTemp = new print.Print(Integer.toString(totalRowsWithData), currentX, currentY);
                    ...
                    if (b > 0) {
                        ...
                        Print printListTemp = new Print(temp, currentX, currentY);
                        //print.Print printListTemp = new print.Print(Integer.toString(totalColumnsWithData), currentX, currentY);
                        columnPrint.add(printListTemp);
                        listPrint.add(columnPrint);
                        columnPrint = new ArrayList<>();
                    }
