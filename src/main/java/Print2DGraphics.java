...
public class Print2DGraphics implements Printable {
    ...
    public Print2DGraphics(JFrame frame) {
        ...
        //attr_set.add(MediaSize.getMediaSizeForName(MediaSizeName.ISO_A4));
    ...
    public static void mainPrint2(JFrame frame) {
        Print2DGraphics sp = new Print2DGraphics(frame);
    }
}
